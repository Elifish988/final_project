...
from Analysis_data.service_map.service_map_fank import get_avg_casualties_by_region_servie_map
...
def get_avg_casualties_by_region():
    ...
    return get_avg_casualties_by_region_servie_map(result_df)
