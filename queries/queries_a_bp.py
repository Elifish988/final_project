...
@bp_queries.route("/get_top_deadliest_attacks", methods=["GET"])
...
@bp_queries.route("/get_avg_casualties_by_region", methods=["GET"])
...
@bp_queries.route("/get_top_5_gnames_by_casualties", methods=["GET"])
...
@bp_queries.route("/get_percentage_change_in_attacks_by_country", methods=["GET"])
...
@bp_queries.route("/get_most_active_groups_by_region", methods=["GET"])
